...
class QuestionProvider {
    ...
    /**
     Return a question struct using names left in the names to display list. Return `nil` if there's no more name to use, or if we couldn't find the image.
     */
